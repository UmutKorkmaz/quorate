...
## Quorate Island (native monitor + foreign agents)

Quorate Island is a native macOS menu-bar/notch app that shows **every AI-agent
...
# …or: open QuorateIsland.app    # native menu-bar/notch
```
...
> QuorateIsland.app to see live runs, approval cards, and detected processes.
