...
import { createLiveSpoolSink, listPendingApprovals, readMonitorDiscovery, writeApprovalRequest } from "../src/live-spool.js";
import {
  createMonitorServer,
  listenMonitorServer,
...
function tempDir(): string {
  return mkdtempSync(join(tmpdir(), "quorate-island-"));
}

const TEST_KEY = "island-test-token";
