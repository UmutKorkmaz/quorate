...
export const PACK_COVERAGE: Record<string, CoverageEntry[]> = {
  solana: [
    {
      title: "Unchecked account type",
      standard: "sealevel-attacks",
      reference: "sealevel: account-types"
    },
    {
    ...
    },
    {
      ...
      standard: "sealevel-attacks",
      reference: "sealevel: panic-denial-of-service"
    },
    {
      title: "Non-canonical PDA bump",
      standard: "sealevel-attacks",
      reference: "sealevel: bump-seed-canonicalization"
    },
    {
      title: "Manual account closing",
      standard: "sealevel-attacks",
      reference: "sealevel: closing-accounts"
    },
    {
  ...
  evm: [
    {
      ...
      standard: "SWC",
      reference: "SWC-115 tx.origin"
    },
    {
      title: "delegatecall to untrusted target",
      standard: "SWC",
      reference: "SWC-112 delegatecall"
    },
    {
      title: "selfdestruct present",
      standard: "SWC",
      reference: "SWC-106 selfdestruct"
    },
    {
      title: "Inline assembly",
      standard: "SWC",
      reference: "SWC-127 arbitrary-jump / unsafe-assembly"
    },
    {
      title: "block.timestamp/number dependence",
      standard: "SWC",
      reference: "SWC-116 timestamp-dependence"
    },
    {
      title: "Unbounded loop over dynamic array",
      standard: "SWC",
      reference: "SWC-128 dos-unbounded-loop"
    },
    {
    ...
    },
    {
      ...
      standard: "SWC",
      reference: "SWC-105 unprotected-ether-withdrawal"
    },
    {
      title: "Unchecked low-level call return",
      standard: "SWC",
      reference: "SWC-104 unchecked-call-return"
    },
    {
      title: "Unchecked ERC20 transfer return",
      standard: "SWC",
      reference: "SWC-104 unchecked-erc20-return"
    }
  ],
  ...
  iac: [
    {
      ...
      standard: "CIS",
      reference: "CIS-AWS S3 public access"
    },
    {
      title: "Unrestricted ingress (0.0.0.0/0)",
      standard: "CIS",
      reference: "CIS-AWS unrestricted-ingress"
    },
    {
      title: "Encryption disabled",
      standard: "CIS",
      reference: "CIS-AWS encryption-at-rest"
    },
    {
      title: "Public IP assignment",
      standard: "CIS",
      reference: "CIS-AWS public-ip-assignment"
    },
    {
      title: "Hardcoded secret in IaC",
      standard: "CIS",
      reference: "CIS-AWS hardcoded-credentials"
    },
    {
      title: "Privileged container",
      standard: "CIS",
      reference: "CIS-K8s privileged-container"
    },
    {
      title: "Host namespace sharing",
      standard: "CIS",
      reference: "CIS-K8s host-namespace-sharing"
    },
    {
      title: "Container runs as root",
      standard: "CIS",
      reference: "CIS-K8s run-as-non-root"
    },
    {
      title: "Privilege escalation allowed",
      standard: "CIS",
      reference: "CIS-K8s allow-privilege-escalation"
    },
    {
      title: "Mutable image tag (:latest)",
      standard: "CIS",
      reference: "CIS-K8s mutable-image-tag"
    }
  ],
  ...
  llm: [
    ...
    },
    {
      ...
      standard: "OWASP-LLM",
      reference: "LLM02 Insecure Output Handling"
    },
    {
    ...
    },
    {
      ...
      standard: "OWASP-LLM",
      reference: "LLM07 Insecure Plugin/Tool Design"
    },
    {
      title: "Hardcoded LLM API key",
      standard: "OWASP-LLM",
      reference: "LLM06 Sensitive Info Disclosure"
    },
    {
    ...
    },
    {
      ...
      standard: "OWASP-LLM",
      reference: "LLM08 Excessive Agency"
    },
    {
  ...
  move: [
    {
      ...
      standard: "Move",
      reference: "access-control: public-entry-exposure"
    },
    {
      title: "Global storage mutated without owner check",
      standard: "Move",
      reference: "access-control: borrow-global-mut-unchecked"
    },
    {
      title: "Resource removed from storage",
      standard: "Move",
      reference: "resource-safety: move-from-unchecked"
    },
    {
      title: "Object shared publicly",
      standard: "Move",
      reference: "access-control: shared-object-exposure"
    },
    {
      title: "Struct has copy ability",
      standard: "Move",
      reference: "resource-safety: copy-ability-on-valuable-struct"
    },
    {
      title: "Integer downcast (truncation)",
      standard: "Move",
      reference: "resource-safety: integer-truncation"
    },
    {
      title: "Unguarded privileged function",
      standard: "Move",
      reference: "capability-safety: unguarded-privileged-function"
    },
    {
      title: "Unchecked vector index",
      standard: "Move",
      reference: "resource-safety: unchecked-vector-index"
    },
    {
      title: "Key resource has drop ability",
      standard: "Move",
      reference: "resource-safety: drop-ability-on-key-resource"
    },
    {
      title: "Initializer/admin entrypoint",
      standard: "Move",
      reference: "access-control: initializer-admin-entrypoint"
    }
  ],
  ...
  ci: [
    {
      ...
      standard: "OpenSSF",
      reference: "Scorecard: Dangerous-Workflow"
    },
    {
      title: "Untrusted input in workflow expression",
      standard: "OpenSSF",
      reference: "CWE-78 command-injection via expression"
    },
    {
      title: "Action not pinned to a commit SHA",
      standard: "OpenSSF",
      reference: "Scorecard: Pinned-Dependencies"
    },
    {
      title: "Over-broad workflow permissions",
      standard: "OpenSSF",
      reference: "Scorecard: Token-Permissions"
    },
    {
    ...
    },
    {
      ...
      standard: "OpenSSF",
      reference: "CWE-78 supply-chain-install-script"
    },
    {
      title: "Hardcoded registry/auth token",
      standard: "OpenSSF",
      reference: "CWE-798 hardcoded-credential"
    },
    {
  ...
  fintech: [
    {
      ...
      standard: "PCI-DSS",
      reference: "PCI 3.4 PAN-protection"
    },
    {
      title: "Card data in logs",
      standard: "PCI-DSS",
      reference: "PCI 3.2 no-CVV-storage"
    },
    {
    ...
    },
    {
      ...
      standard: "PCI-DSS",
      reference: "PCI 6.4 secure-software-practices"
    },
    {
      title: "Floating-point arithmetic on money",
      standard: "PCI-DSS",
      reference: "PCI 6.4 secure-coding-monetary-precision"
    },
    {
    ...
    },
    {
      ...
      standard: "PCI-DSS",
      reference: "PCI 6.3 injection-prevention"
    }
  ],
  ...
  web: [
    ...
    },
    {
      ...
      standard: "OWASP",
      reference: "A03 Injection"
    },
    {
      title: "Path traversal (untrusted input in a file path)",
      standard: "OWASP",
      reference: "A01 Broken Access Control"
    },
    {
    ...
    },
    {
      ...
      standard: "OWASP",
      reference: "A05 Security Misconfiguration"
    },
    {
    ...
    },
    {
      ...
      standard: "OWASP",
      reference: "A08 Insecure Deserialization"
    },
    {
      title: "Weak or broken cryptographic algorithm",
      standard: "OWASP",
      reference: "A02 Cryptographic Failures"
    }
  ],
  ...
  healthcare: [
    {
      ...
      standard: "HIPAA",
      reference: "164.312(b) audit"
    },
    {
      title: "PHI stored in plaintext literal",
      standard: "HIPAA",
      reference: "164.312(a) access-control"
    },
    {
      title: "PHI in URL/query string",
      standard: "HIPAA",
      reference: "164.312(e) transmission-security"
    },
    {
    ...
    },
    {
      ...
      standard: "HIPAA",
      reference: "164.514 de-identification"
    },
    {
    ...
    },
    {
      ...
      standard: "HIPAA",
      reference: "164.502(b) minimum-necessary"
    },
    {
  ...
  mobile: [
    ...
    },
    {
      ...
      standard: "MASVS",
      reference: "MASVS-NETWORK"
    },
    {
      title: "Exported Android component",
      standard: "MASVS",
      reference: "MASVS-PLATFORM"
    },
    {
    ...
    },
    {
      ...
      standard: "MASVS",
      reference: "MASVS-RESILIENCE"
    },
    {
      title: "Insecure randomness for a security value",
      standard: "MASVS",
      reference: "MASVS-CRYPTO"
    },
    {
