...
```bash
# copy and rename to activate
cp .github/workflows/quorate-fintech.example.yml .github/workflows/quorate.yml
```

The example workflow lives at `.github/workflows/quorate-fintech.example.yml` in the
[Quorate repository](https://github.com/UmutKorkmaz/quorate). Set `OPENROUTER_API_KEY`
...
```bash
# copy and rename to activate
cp .github/workflows/quorate-healthcare.example.yml .github/workflows/quorate.yml
```

The example workflow lives at `.github/workflows/quorate-healthcare.example.yml` in the
[Quorate repository](https://github.com/UmutKorkmaz/quorate). Set `OPENROUTER_API_KEY`
...
```bash
# copy and rename to activate
cp .github/workflows/quorate-mobile.example.yml .github/workflows/quorate.yml
```

The example workflow lives at `.github/workflows/quorate-mobile.example.yml` in the
[Quorate repository](https://github.com/UmutKorkmaz/quorate). Set `OPENROUTER_API_KEY`
...
```bash
# copy and rename to activate
cp .github/workflows/quorate-web.example.yml .github/workflows/quorate.yml
```

The example workflow lives at `.github/workflows/quorate-web.example.yml` in the
[Quorate repository](https://github.com/UmutKorkmaz/quorate). Set `OPENROUTER_API_KEY`
